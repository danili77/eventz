...
<div class="evento-index">
  ...
  <?php foreach ($eventos as $evento) {?>
    ...
    <?= Html::a('Eliminar', ['delete', 'id' => $evento->id], [
      ...
      <?= Html::a('Comentar',['comentarios/create', 'id' => $evento->id],['class' => 'btn btn-xs btn-success']); ?><br><br>
      ...
      <a href="../eventos/view?id=<?= $evento->id?>">Comentarios (<?= $evento->cuantosComentarios($evento->id); ?>)</a>
